  ...
  const experiences = [
    {
      ...
      achievements: [
        'Optimizing and enhancing existing e-commerce platform built on MERN stack to improve performance, scalability, and reliability',
        'Implementing feature improvements, refactoring code, and resolving production issues based on change requests',
        'Managing application deployments, environment configurations, and post-deployment validation',
        'Conducting unit testing, debugging, and performance tuning to ensure smooth production delivery',
        'Collaborating with cross-functional teams to support continuous improvement and customer-focused enhancements',
      ],
      technologies: ['React.js', 'Node.js', 'Express.js', 'MongoDB', 'Git', 'Agile'],
    },
    {
      company: 'Business Curative',
      ...
      achievements: [
        'Designed and developed a full-featured e-commerce platform from scratch using the MERN stack',
        'Implemented core modules including product catalog, cart management, authentication, and order workflows',
        'Built RESTful APIs and integrated frontend with backend services and databases',
        'Performed initial testing, bug fixing, and documentation to support production readiness',
      ],
    ...
    },
    {
      ...
      technologies: ['React.js', 'JavaScript', 'REST APIs', 'UI/UX Optimization'],
    },
    {
      ...
      technologies: ['Python', 'TensorFlow', 'Machine Learning', 'Neural Networks'],
    },
  ];
